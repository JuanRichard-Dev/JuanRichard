...
PAGE_DESCRIPTIONS: dict[str, dict[str, str]] = {
    "Resumo Executivo": {
        "pt": "Indicadores consolidados, evolução e distribuição dos dados do Serviço Médico.",
        "en": "Consolidated indicators, trends and Medical Service priorities.",
        "fr": "Indicateurs consolidés, tendances et priorités du Service Médical.",
    },
    "Exames": {
        "pt": "Volume, cobertura e distribuição dos exames ocupacionais.",
        "en": "Volume, coverage and distribution of occupational exams.",
        "fr": "Volume, couverture et répartition des examens professionnels.",
    },
    "Atendimentos": {
        "pt": "Demanda ambulatorial, perfil dos atendimentos e tendências de procura.",
        "en": "Outpatient demand, appointment mix and service trends.",
        "fr": "Demande ambulatoire, profil des consultations et tendances de recours.",
    },
    "Afastamentos": {
        "pt": "Volume, dias perdidos, causas e distribuição dos afastamentos.",
        "en": "Incidence, lost days, causes and operational impact of leaves.",
        "fr": "Incidence, jours perdus, causes et impact opérationnel des arrêts.",
    },
    "Saúde Mental": {
        "pt": "Triagens SRQ-20, evolução mensal e distribuição por unidade.",
        "en": "SRQ-20 screening, unit concentration and psychosocial risk signals.",
        "fr": "Dépistage SRQ-20, concentration par unité et signaux de risque psychosocial.",
    },
}
...
def page_description(page: str, language: str = "pt") -> str:
    """Return the page-specific executive subtitle."""
    language = normalize_language(language)
    values = PAGE_DESCRIPTIONS.get(page, {})
    return values.get(language) or values.get("pt") or tr("dashboard_subtitle", language)
